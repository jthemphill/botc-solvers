...
export const PLAYERS = [
  ...
  new Librarian({ name: "Oscar", role: Klutz, among: ["You", "Olivia"], timing: "night_1" }),
  new Chef({ name: "Adam", count: 1, timing: "night_1" }),
  new Empath({
    name: "Josh",
    infoClaims: [
      {
  ...
  new Klutz({
    name: "Olivia",
    infoClaims: [{ timing: "night_2", learned: (game) => game.isGood("Adam") }],
  }),
  new FortuneTeller({
    name: "Steph",
    infoClaims: [
  ...
  new Washerwoman({ name: "Fraser", role: Virgin, among: ["Olivia", "Sula"], timing: "night_1" }),
];
